			...
			<div class="mx-auto w-full max-w-screen-xl px-8 py-6 lg:py-8">
				<div class="md:flex md:justify-between">
					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						...
						<div className="">
							<h2 class="mb-4 text-sm font-semibold uppercase text-white">EDITED BY</h2>
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/whoouuzii/" class="hover:underline ">
										FAUZI
									</a>
								</li>
								<li>
									<a href="https://www.instagram.com/xii.vilians/" class="hover:underline">
										XII-6
									</a>
								</li>
							</ul>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Kelas XII-6 | Di Kelola Oleh Siswa XII-6
						</p>
					</div>
				</div>
			</div>
