	...
	return (
		<div className="z-1 relative h-auto lg:overflow-hidden">
			...
			<div data-aos="fade-up" data-aos-duration="500" className="mt-14 md:mt-10">
				<BorderStruktur Jabatan="Wali Kelas" Nama="Endah Purwa Ekawati, S.IP., Gr." Width="150px" />
			</div>
			<div className="flex flex-col justify-center items-center">
				...
				<div className="flex relative top-[-3rem]" data-aos="fade-up" data-aos-duration="1200">
					<div className="relative left-[0.2rem]">
						<BorderStruktur Jabatan="Ketua Kelas" Nama="Annisa" Width="120px" />
					</div>
					...
					<div className="relative right-[0.2rem]">
						<BorderStruktur Jabatan="Wakil Ketua" Nama="Fachri" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Sekertaris" Nama="Azahra" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Chika" Width="120px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Bendahara" Nama="Ain Andini" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Nalayani" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Keamanan" Nama="Aulia" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Dias" Width="120px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Kerohanian" Nama="Erlanda" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Rita" Width="120px" />
					</div>

					<div className="flex-col hidden lg:flex">
						<BorderStruktur Jabatan="Pendidikan" Nama="Sekar" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Diska" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Pendidikan" Nama="Diska" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					data-aos-duration="1100">
					<div className="flex-col">
						<BorderStruktur Jabatan="Peralatan" Nama="Rianti" Width="120px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Peralatan" Nama="Indi" Width="120px" />
					</div>
				</div>
				...
				<div className=" absolute bottom-[15%] lg:bottom-[20%] " data-aos="fade-up" data-aos-duration="1000">
					<div className="flex justify-center items-center flex-col">
						...
						<div className="relative bottom-3">
							<BorderStruktur Jabatan="Peralatan" Nama="Haikal" Width="120px" />
						</div>
					</div>
				</div>
				...
				{/* 	<div
					...
					<div className="flex justify-center items-center flex-col">
						...
						<img src="Circle.svg" alt="" className="relative top-[-0.7rem]" />
						<div className="relative bottom-3">
							<BorderStruktur Jabatan="Kesehatan" Nama="Sekar" Width="120px" />
							<div className="py-[3%]"></div>
							<BorderStruktur Jabatan="" Nama="Diska" Width="120px" />
						</div>
					</div>
